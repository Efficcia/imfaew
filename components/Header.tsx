          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <div className="flex items-center">
                ...
                <h1 className="text-xl font-bold text-gray-900">Sistema de Notificações</h1>
              </div>
            </div>
            <nav className="hidden md:ml-8 md:flex md:space-x-8">
              <Link
                href="/"
                className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors"
              >
